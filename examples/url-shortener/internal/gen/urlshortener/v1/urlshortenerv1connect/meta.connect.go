...
const (
	...
	MetaServiceName = "urlshortener.v1.MetaService"
)
...
const (
	...
	MetaServiceGetVersionProcedure = "/urlshortener.v1.MetaService/GetVersion"
)

// MetaServiceClient is a client for the urlshortener.v1.MetaService service.
type MetaServiceClient interface {
	GetVersion(context.Context, *connect.Request[v1.GetVersionRequest]) (*connect.Response[v1.GetVersionResponse], error)
}

// NewMetaServiceClient constructs a client for the urlshortener.v1.MetaService service. By default,
...
func NewMetaServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MetaServiceClient {
	...
	metaServiceMethods := v1.File_urlshortener_v1_meta_proto.Services().ByName("MetaService").Methods()
...
// GetVersion calls urlshortener.v1.MetaService.GetVersion.
...
// MetaServiceHandler is an implementation of the urlshortener.v1.MetaService service.
...
func NewMetaServiceHandler(svc MetaServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/urlshortener.v1.MetaService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMetaServiceHandler) GetVersion(context.Context, *connect.Request[v1.GetVersionRequest]) (*connect.Response[v1.GetVersionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("urlshortener.v1.MetaService.GetVersion is not implemented"))
}
